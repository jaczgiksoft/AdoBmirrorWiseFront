    ...
    useHotkeys(
        {
            escape: () => {
                ...
                navigate("/settings", { state: { from: "/settings/positions" } });
            },
            arrowdown: (e) => {
                if (confirmOpen || showForm) return "prevent";
                e.preventDefault();
        ...
        <div className="bg-slate-50 dark:bg-dark flex flex-col font-sans text-slate-900 dark:text-slate-50 h-full">
            ...
            >
                ...
                <div className="flex items-center gap-4 mb-6 flex-wrap">
                    <button
                        onClick={() => navigate("/settings", { state: { from: "/settings/positions" } })}
                ...
                {paginatedItems.length === 0 ? (
                    <div className="text-center py-20 bg-white dark:bg-secondary/30 rounded-2xl border border-dashed border-slate-300 dark:border-slate-700">
                        ...
                        <p className="text-xs text-slate-400 mt-1 italic">Define los cargos operativos de tu equipo aquí.</p>
                    </div>
                ) : (
                                    ...
                                    <div className="flex items-center gap-5">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-slate-500 dark:text-slate-400 line-clamp-1 max-w-md">
                                                {item.description || "Sin descripción de funciones registrada."}
                                            </p>
                                        </div>
                                    </div>
            ...
            <ConfirmDialog
                ...
                message={
                    itemToDelete
                        ? `¿Estás seguro de que deseas eliminar el puesto "${itemToDelete.name}"? Los usuarios asociados podrían perder su cargo.`
                        : ""
                }
