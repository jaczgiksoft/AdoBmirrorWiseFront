...
import {
    ...
    ATTACHMENT_CUSTOM_CONFIG,
    DENTAL_TYPES,
    RADIAL_MENU_DEFAULT_SIZES,
    RADIAL_MENU_CUSTOM_SIZES,
    getRadialMenuSizes,
    OCCLUSAL_TYPES,
    TOOTH_COORDINATES,
    MICRO_ADJUSTMENTS_PERMANENT,
    MICRO_ADJUSTMENTS_DECIDUOUS,
    TAD_MICRO_ADJUSTMENTS,
    TAD_CUSTOM_CONFIG,
    QUADRANTS,
    UPPER_ARCH_IDS,
    LOWER_ARCH_IDS,
    buildInitialToothStates,
    RADIAL_MENU_CUSTOM_ROTATION,
    getToothPositionConfig
...
function PeriodontalOverlay({ data, isUpper, toothId }) {
    ...
    const toothPositionConfig = getToothPositionConfig(isUpper);

    // Default general molars configs for fallback (like for baby teeth)
    const config = toothPositionConfig[toothId] || toothPositionConfig[18];
