...
function PrescriptionCard({ prescription: rx, onEdit, onDelete }) {
    ...
    return (
        ...
        ">
            ...
            <div className="absolute top-3 right-3 flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-all duration-200 translate-y-1 group-hover:translate-y-0 bg-white/90 dark:bg-slate-800/90 rounded-lg p-1 shadow-sm">
