    ...
    const columns = [
        ...
        },
        {
            ...
            render: (row) => {
                ...
                return cfg ? (
                    <span className={`px-3.5 py-1.5 rounded-full text-xs font-bold border ${cfg.cls}`}>
                        {cfg.label}
                    </span>
                ) : (
            ...
            render: (row) => (
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-lg text-primary border border-primary/30 hover:bg-primary/10 transition"
                    >
                        <Eye size={13} />
                        Ver
                    </button>
                    ...
                    {!row.invoiced && row.status !== "pending" && (
                        <button
                            ...
                            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-lg text-emerald-600 border border-emerald-500/30 hover:bg-emerald-500/10 transition"
                        >
                            <FileCheck2 size={13} />
                            Facturar
                        </button>
